...
if ( ! class_exists( 'promethues_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	
	 */
	class promethues_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'promethues' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'promethues' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'promethues' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'promethues' ),
						'full'    => esc_html__( 'Full text', 'promethues' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-promethues-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'promethues_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new promethues_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'promethues' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
