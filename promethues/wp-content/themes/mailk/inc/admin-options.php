...

{
    ...
    ?>
        ...
        <p class="description">Enter Primary Consult Number</p>

    <?php

}
// Sconary Consult number

function display_secondary_consult_number()

{

    ?>

        <input type="text" name="secondary_consult_number" id="secondary_consult_number" class="regular-text" value="<?php echo get_option('secondary_consult_number'); ?>" />

        <p class="description">Enter Secondary Consult Number</p>
...
function display_secondary_email()

{

    ?>

        <input type="secondary_email" name="secondary_email" id="secondary_email" class="regular-text" value="<?php echo get_option('secondary_email'); ?>" />

        <p class="description">Enter your Secondary Email</p>
...

{
    ...
    add_settings_field("consult_number", "Primary Consult Number", "display_consult_number", "site-information", "section");

    add_settings_field("secondary_consult_number", "Seconary Consult Number", "display_secondary_consult_number", "site-information", "section");

    add_settings_field("email", "Primary Email Id", "display_email", "site-information", "section");

    add_settings_field("secondary_email", "Secondary Email Id", "display_secondary_email", "site-information", "section");
    ...
    register_setting("section", "secondary_consult_number");

    register_setting("section", "email");

    register_setting("section", "secondary_email");
